...
\begin{keybox}
Documento de estudio consolidado a partir de las 8 preguntas de examen. Todas comparten
\textbf{un mismo marco teórico} (enfoque ``San Martín''): una base de datos es un
\textbf{espacio empírico de probabilidad}, las variables son \textbf{funciones} sobre las
etiquetas, y la \textbf{esperanza condicional es una proyección ortogonal} en el espacio de
Hilbert $L^2$. Domina este marco y las 8 preguntas se resuelven casi mecánicamente.
\end{keybox}
